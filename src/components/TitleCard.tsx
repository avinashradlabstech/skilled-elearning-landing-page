  ...
  return (
    <>
      <div className="flex flex-col items-start">
        <div className="flex pl-8 content-center gap-8 relative">
          <svg
            width="56"
            height="56"
        ...
        <div className="px-400 pt-800 pb-500 gap-100 shadow-card rounded-15 bg-gradient-orange h-full -mt-28">
          <div className="flex flex-col items-start gap-300">
            <div className="text-sans font-extrabold leading-28.8 lg:leading-38.4 self-stretch text-white text-24 lg:text-32 md:w-[16.5rem] lg:w-[18rem]">
              {heading}
            </div>
          </div>
        </div>
